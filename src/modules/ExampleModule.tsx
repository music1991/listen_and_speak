...
const letterExamples: LetterExample[] = [
  { letter: 'A', example: { en: 'Automobile', es: 'Automóvil' } },
  { letter: 'B', example: { en: 'Book', es: 'Libro' } },
  { letter: 'C', example: { en: 'Cat', es: 'Gato' } },
  { letter: 'D', example: { en: 'Door', es: 'Puerta' } },
  { letter: 'E', example: { en: 'Elephant', es: 'Elefante' } },
  { letter: 'F', example: { en: 'Flower', es: 'Flor' } },
  { letter: 'G', example: { en: 'Garden', es: 'Jardín' } },
  { letter: 'H', example: { en: 'House', es: 'Casa' } },
  { letter: 'I', example: { en: 'Ice cream', es: 'Helado' } },
  { letter: 'J', example: { en: 'Jungle', es: 'Jungla' } },
  { letter: 'K', example: { en: 'Kangaroo', es: 'Canguro' } },
  { letter: 'L', example: { en: 'Light', es: 'Luz' } },
  { letter: 'M', example: { en: 'Mountain', es: 'Montaña' } },
  { letter: 'N', example: { en: 'Night', es: 'Noche' } },
  { letter: 'O', example: { en: 'Ocean', es: 'Océano' } },
  { letter: 'P', example: { en: 'Pencil', es: 'Lápiz' } },
  { letter: 'Q', example: { en: 'Queen', es: 'Reina' } },
  { letter: 'R', example: { en: 'River', es: 'Río' } },
  { letter: 'S', example: { en: 'Sun', es: 'Sol' } },
  { letter: 'T', example: { en: 'Tree', es: 'Árbol' } },
  { letter: 'U', example: { en: 'Umbrella', es: 'Paraguas' } },
  { letter: 'V', example: { en: 'Vehicle', es: 'Vehículo' } },
  { letter: 'W', example: { en: 'Window', es: 'Ventana' } },
  { letter: 'X', example: { en: 'Xylophone', es: 'Xilófono' } },
  { letter: 'Y', example: { en: 'Yoga', es: 'Yoga' } },
  { letter: 'Z', example: { en: 'Zebra', es: 'Cebra' } },
];
